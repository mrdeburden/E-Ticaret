...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Poppins', sans-serif; }
        ...
        .category-bar { background: white; padding: 10px 10%; display: flex; justify-content: center; gap: 20px; border-bottom: 1px solid #eee; flex-wrap: wrap; }
        .cat-link { color: #555; font-size: 15px; font-weight: 500; padding: 5px 15px; border-radius: 20px; }
...
<body>
        ...
        <div class="auth-buttons">
            <?php if ($current_user_id): ?>
                ...
                <div class="dropdown-container">
                    <button class="sepet-btn" onclick="toggleMenu('sepet-dropdown')"><i class="fas fa-shopping-cart"></i> (<?php echo $sepet_sayisi; ?>)</button>
                ...
                <div class="dropdown-container">
                    <div class="sepet-btn" style="background:#333; margin-left:10px;" onclick="toggleMenu('user-dropdown')">👤 <?php echo htmlspecialchars($_SESSION['username']); ?></div>
    ...
    <section class="hero">
        <h1><?php echo $secilen_kategori ? ucfirst($secilen_kategori) . " Ürünleri" : "Aradığın Her Şey Burada"; ?></h1>
    ...
    <div class="container">
        <div class="product-grid">
            ...
            $sql = "SELECT p.*, u.username as satici_adi 
                    FROM products p 
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <div class="seller-badge">
                            <i class="fas fa-user-tag"></i> Satıcı: <?php echo htmlspecialchars($u['satici_adi']); ?>
                        </div>
                        ...
                        <div class="product-footer">
                            ...
                            <?php else: ?>
                                <form action="sepet_islem.php" method="POST">
                                    ...
                                    <button type="submit" name="sepete_ekle" class="buy-btn"><i class="fas fa-cart-plus"></i> Ekle</button>
                                </form>
                            <?php endif; ?>
                        </div>
                    </div>
